export class Card {
    ...
    _setEventListeners() {
        ...
        this._elementDelete.addEventListener('click', () => this._handleDeleteCard(this._cardTemplate));
    ...
    generateCard() {
        ...
        if (this._item.owner._id === this._myId) {
            this._cardTemplate.querySelector('.element__delete').classList.add('element__delete_active')
        } else {
            this._cardTemplate.querySelector('.element__delete').classList.remove('element__delete_active')
        };
    ...
    _setLike() {
        const like = this._cardTemplate.querySelector(".element__like");
